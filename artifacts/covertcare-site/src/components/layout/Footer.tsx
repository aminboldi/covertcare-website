        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-7 lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link href="/research" className="text-sm text-primary-foreground/80 hover:text-white transition-colors">Research</Link>
              <a href="/pitch/" className="text-sm text-primary-foreground/80 hover:text-white transition-colors inline-flex items-center gap-1.5">
                Partner deck
